...
class _CvListState extends State<CvList> {
  ...
  List<CvModel> _cvList = [
    ...
    CvModel('master', 16.0, 'done'),
    CvModel('bachelor', 16.0, 'done'),
    CvModel('experience', 22.0, 'length'),
    CvModel('sonat', 16.0, '0.5 year'),
    CvModel('zdata', 16.0, '1.5 year'),
    CvModel('sbanken', 16.0, '1.5 year'),
    CvModel('school', 22.0, 'study time'),
    CvModel('queensland university of technology', 16.0, '0.5 years'),
    CvModel('western norway university of applied sciences', 16.0, '4.5 years'),
    CvModel('knowledge', 22.0, 'level'),
    CvModel('flutter', 16.0, 'great'),
    CvModel('dart', 16.0, 'great'),
    CvModel('c#', 16.0, 'great'),
    CvModel('f#', 16.0, 'great'),
    CvModel('haskell', 16.0, 'great'),
    CvModel('dotnet', 16.0, 'great'),
    CvModel('golang', 16.0, 'great'),
    CvModel('vue', 16.0, 'great'),
    ...
    CvModel('git', 16.0, 'good'),
    CvModel('docker', 16.0, 'good'),
    CvModel('grpc', 16.0, 'good'),
